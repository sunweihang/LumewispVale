...
def main():
    ...
    write_data(
        ...
        [
            ...
            [5, "SelectHand", "睡醒后空手点成熟作物收获。也可用催熟剂跳过一晚。"],
    ...
    write_data(
        ...
        [
            ...
            [1005, "浇灌作物", "选中水壶给作物浇水。完成后获得催熟剂；夜里睡一觉田才会熟。", 5, "", 2, 4, 25, "boost", 2, 1035, 50, "quest_1005", "", "farm", ""],
            [1035, "第一夜", "天色不早了，点小屋门睡到明天。浇过水的作物会在夜里长大。", 10, "sleep_first", 1, 28, 20, "", 0, 1006, 55, "quest_1035", "", "farm", ""],
            [1006, "丰收时刻", "睡醒后空手点击成熟作物收获。也可用催熟剂跳过一晚。", 6, "", 2, 5, 40, "parsnip", 1, 1032, 60, "quest_1006", "", "farm", ""],
