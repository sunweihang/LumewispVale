/*
 * AUTO-GENERATED by tools/story/generate_dialogue_stories.mjs from story graph 10029.
 * Do not edit manually — re-export from the story editor, or re-run the generator.
 */
import { AbsStory } from '../AbsStory';

export class TsStory10029 extends AbsStory {
    public readonly storyId = 10029;
