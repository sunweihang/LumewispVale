...
exports.BUILTIN_WHITELIST = exports.GUIDE_NODE_DEFS = exports.GUIDE_BUILTIN_NODE_DEFS = exports.ENTRANCE_TYPE = exports.ENTRANCE_LIFECYCLE_PORTS = void 0;
exports.guideNodeTypeNames = guideNodeTypeNames;
exports.findGuideNodeDef = findGuideNodeDef;
exports.allGuideRegisterNodes = allGuideRegisterNodes;
...
const FLOW_AIMED = { name: '已瞄准', portType: Flow };
const FLOW_MISS = { name: '未命中', portType: Flow };
/** 引导入口：每帧解析当前箭头目标（sync）。 */
exports.ENTRANCE_LIFECYCLE_PORTS = [{ name: '解析', method: 'onResolve', async: false }];
exports.ENTRANCE_TYPE = 'GuideEntranceBlueprint';
const TOOL_OPTS = [
    { label: '手', value: 'hand' },
    { label: '锄头', value: 'hoe' },
...
exports.GUIDE_BUILTIN_NODE_DEFS = [
    {
        typeName: 'FloatConst',
        title: '浮点常量',
        category: '数学',
...
exports.BUILTIN_WHITELIST = exports.GUIDE_BUILTIN_NODE_DEFS.map((d) => d.typeName);
function guideNodeTypeNames() {
    return exports.GUIDE_NODE_DEFS.map((d) => d.typeName);
}
function findGuideNodeDef(typeName) {
    return (exports.GUIDE_NODE_DEFS.find((n) => n.typeName === typeName) ||
        exports.GUIDE_BUILTIN_NODE_DEFS.find((n) => n.typeName === typeName));
}
function allGuideRegisterNodes() {
    return [...exports.GUIDE_NODE_DEFS, ...exports.GUIDE_BUILTIN_NODE_DEFS];
}
//# sourceMappingURL=guideNodes.js.map