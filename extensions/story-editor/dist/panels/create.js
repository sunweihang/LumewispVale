  ...
  `,
    ...
    ready() {
        ...
        const close = () => {
            var _a, _b;
            try {
                (_b = (_a = Editor.Panel).close) === null || _b === void 0 ? void 0 : _b.call(_a, 'story-editor.create');
            }
            catch {
                /* ignore */
            }
        ...
        const submit = async () => {
            var _a, _b;
            const storyId = Number(String((_a = idInput === null || idInput === void 0 ? void 0 : idInput.value) !== null && _a !== void 0 ? _a : '').trim());
            ...
            if (!(result === null || result === void 0 ? void 0 : result.ok)) {
                await Editor.Dialog.error((result === null || result === void 0 ? void 0 : result.error) || '创建失败', { title: '创建剧情', buttons: ['确定'], default: 0 });
                return;
            }
            try {
