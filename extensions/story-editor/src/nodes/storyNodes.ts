...
export const ENTRANCE_TYPE = 'StoryEntranceBlueprint';

export const STORY_BUILTIN_NODE_DEFS: NodeDefinition[] = [
  {
    typeName: 'FloatConst',
    title: '浮点常量',
    category: '数学',
...
export const STORY_NODE_DEFS: NodeDefinition[] = [
  {
...
export const BUILTIN_WHITELIST = STORY_BUILTIN_NODE_DEFS.map((d) => d.typeName);

export function storyNodeTypeNames(): string[] {
  return STORY_NODE_DEFS.map((d) => d.typeName);
}

export function allStoryRegisterNodes(): NodeDefinition[] {
  return [...STORY_NODE_DEFS, ...STORY_BUILTIN_NODE_DEFS];
}

export function findStoryNodeDef(typeName: string): NodeDefinition | undefined {
